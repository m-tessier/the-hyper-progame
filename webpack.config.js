// On importe le plug-in "MiniCSSExtract" pour récupérer tous nos fichiers CSS et les bundler en un seul fichier CSS
...
module.exports = {
  ...
  module: {
    rules: [
      ...
      {
        // Pour le SASS :
        test: /\.(sa|sc|c)ss$/, // On applique notre règle aux fichiers .sass, .scss et .css
        use: [
      ...
      {
        // Pour les loader externe : file-loader IMAGES
      ...
      {
        // Pour les loader externe : file-loader FONTS
